...
<p align="center">
  <img src="docs/assets/nexus-hero.png" alt="NEXUS Agent Platform overview" width="100%" />
</p>

<p align="center"><sub>Overview of the main control surface and core platform modules.</sub></p>
...
The README uses screenshots only where they support the engineering discussion:

| Section | Image purpose |
|---|---|
| Top of README | Overall platform overview |
| Architecture | Technical product/system overview |
| Frontend | Authentication and role-aware access |
| System health | Runtime observability |
| Benchmarking | Performance and concurrency validation |

This keeps the document technical rather than turning it into a gallery.
...
<p align="center">
  <img src="docs/assets/nexus-blueprint.png" alt="NEXUS technical product overview" width="94%" />
</p>

<p align="center"><sub>Technical product overview: workflow operations, health monitoring, approvals, MCP tools, and benchmark visibility.</sub></p>
...
<p align="center">
  <img src="docs/assets/nexus-auth.png" alt="NEXUS authentication interface" width="92%" />
</p>

<p align="center"><sub>Authentication and role-aware access to the agent operations workspace.</sub></p>
...
<p align="center">
  <img src="docs/assets/nexus-health.png" alt="NEXUS system health view" width="92%" />
</p>

<p align="center"><sub>Runtime health view for API availability and response timing.</sub></p>
...
<p align="center">
  <img src="docs/assets/nexus-benchmarks.png" alt="NEXUS benchmark view" width="92%" />
</p>

<p align="center"><sub>Measured latency, throughput, and concurrency results separated from synthetic modeling.</sub></p>
...
This project was built to exercise and demonstrate practical engineering skills across multiple layers:
...
- real vs synthetic benchmark separation
...
- dashboard / health / benchmark visualization
...
- local production-style integration testing
